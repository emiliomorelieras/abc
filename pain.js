...
function check(){
 ...
 if(question_turn=="player1"){
  ...
  document.getElementById("player2_question").innerHTML="turno de preguntar"+player2_name;
 }else{
  question_turn="player1"
  document.getElementById("player1_question").innerHTML="turno de preguntar"+player1_name;
 }  
 if(answer_turn=="player1"){
  answer_turn=="player2"
  document.getElementById("player2_answer").innerHTML="turno de responderr"+player2_name;
    
  }else{
    answer_turn="player1"
    document.getElementById("player1_answer").innerHTML="turno de responder"+player1_name;
